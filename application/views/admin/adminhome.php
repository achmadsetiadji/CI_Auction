...
<body id="page-top">
    ...
    <script type="text/javascript" src="<?= base_url() . 'assets/js/demo/chart-area-demo.js'; ?>"></script>
    <script type="text/javascript" src="<?= base_url() . 'assets/js/demo/chart-pie-demo.js'; ?>"></script>
    <script type="text/javascript" src="<?= base_url() . 'assets/js/demo/chart-bar-demo.js'; ?>"></script>
