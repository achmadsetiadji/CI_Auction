        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Officer Table</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><?= $title; ?>
                                <span>
                                    <a href="<?= site_url('AdminDashboard/addofficer') ?>" class="btn btn-primary float-right">
                                        <i class="fas fa-plus"><span class="ml-2">Add Officer</span></i>
                                    </a>
                                </span>
                            </h6>
                        </div>
